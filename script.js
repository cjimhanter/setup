...
function specRow(x){return `<div class="spec-row"><div class="spec-kind">${x.category}</div><div class="spec-name">${x.name}<span class="spec-meta">${x.meta}</span></div><span class="spec-state">${x.status}</span></div>`}
